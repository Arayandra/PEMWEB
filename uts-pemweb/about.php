...
<html lang="en">
  <head>
    <title>Web Advani Rayandra Kahfi About</title>
    <meta charset="utf-8">
  ...
  <?php
	...
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
			<div class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url(images/foto1.jpeg);" data-stellar-background-ratio="0.5">
				...
				<div class="js-fullheight d-flex justify-content-center align-items-center">
					<div class="col-md-8 text text-center">
						...
						<div class="desc">
							...
							<p class="mb-4"><?= $tentangsaya ?></p>
							<ul class="ftco-social mt-3">
                <li class="ftco-animate"><a href="https://id-id.facebook.com/"><span class="icon-facebook"></span></a></li>
